...
void loop()
{
  ...
  if( valueXMapped < -1 || valueYMapped > 1 || valueYMapped < -1 )
  {
      Mouse.move( valueXMapped, valueYMapped );
  }
  else if( valueXMapped > 1 || valueYMapped > 1 || valueYMapped < -1 )
  {
      Mouse.move( valueXMapped, valueYMapped );
  }
  else if( valueYMapped < -1 || valueXMapped > 1 || valueXMapped < -1 )
  {
      Mouse.move( valueXMapped, valueYMapped );
  }
  else if( valueYMapped > 1 || valueXMapped > 1 || valueXMapped < -1 )
